...
import { DisplayIdleScreen } from "@/components/event/display-idle-screen";
 ...
 * While idle, the projector shows the stage landing. The recap itself is the
 * same scroll-through as `/@handle`.
 */
